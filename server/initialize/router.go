...
func Routers() *gin.Engine {
	Router := gin.Default()
	cardRouter := router.RouterGroupApp.Card
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		cardRouter.InitCardEntryRouter(PrivateGroup)
		userRouter.InitUserEntryCardRouter(PrivateGroup)
		userRouter.InitUserAdmLogRouter(PrivateGroup)
