...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/staff/getUserInfo", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/staff/setUserInfo", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/staff/setSelfInfo", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/staff/getUserList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/staff/deleteUser", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/staff/changePassword", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/staff/setUserAuthority", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/staff/setUserAuthorities", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/staff/resetPassword", V2: "POST"},
