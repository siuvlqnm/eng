...
func (s *CardEntryService) CreateCardEntry(c cardReq.CardEntryCreate) (cardId uint, err error) {
	err = global.GVA_DB.Create(&c.CardEntry).Error
	return c.CardEntry.ID, err
}
